...
// for decrption words output(looping)
int i_rnd(int i)
{
    if (!srand_called)
    {
...
int main()
{
    ...
    printf("\n\t Be aware you can be hanged coz Judge is Ma Ma Nang(-_-).");

    printf("\n\n\t Rules : ");
    printf("\n\t - Only 6 mistakes are allowed and please type all letters in lower case.");
    printf("\n\t - Words are name of popular Websites. eg. Google");
    ...
    // Pre result if you want to try real just comment this line
    printf("\n\t The result is : %s\n\n", word);
    int len = strlen(word);
